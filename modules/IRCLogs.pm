## @file
# This file contains the implementation of the IRCLogs block base class.
#
...
## @cmethod $ new(%args)
# Overloaded constructor for IRCLogs block modules. This will ensure that a valid
# item id has been stored in the block object data.
#
# @param args A hash of values to initialise the object with. See the Block docs
#             for more information.
# @return A reference to a new IRCLogs object on success, undef on error.
sub new {
    my $invocant = shift;
...
## @method $ generate_irclogs_page($title, $content, $extrahead, $doclink)
...
sub generate_irclogs_page {
    ...
    my $userbar = $self -> {"module"} -> load_module("IRCLogs::Userbar");
