...
## @class
# Select the appropriate block to render a page based on an IRCLogs URL.
# This allows a url of the form /block/item/path/?args to be parsed into
# something the IRCLogs classes can use to render pages properly, and
# select the appropriate block for the current request.
package IRCLogs::BlockSelector;
...
# data, allowing IRCLogs paths to be passed to the rest of the code without
